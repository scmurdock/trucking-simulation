...
public class TruckingSimulationDataDriver {
    ...
    public static void saveReservation(Reservation reservation) throws Exception{
    ...
    public static void createCheckInStatusUpdates() throws Exception{
        ...
        Reservation newReservationForTruck = createNewReservation(halfCustomer);//we want to create  a new  reservation for the same truck
        saveReservation(newReservationForTruck);//save to Redis to generate new data for simulation
        testReservations.set(randomReservationIndex,newReservationForTruck);//create new reservation to avoid repeat updates of same reservations
